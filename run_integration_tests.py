...
def check_dependencies() -> bool:
    ...
    try:
        ...
        print(
            "ERROR: pytest-asyncio not found. Install with: pip install pytest-asyncio"
        )
        return False
    ...
    try:
        ...
        print(f"✓ specforged package available")
    except ImportError:
        print("WARNING: specforged package not found. Install with: pip install -e .")
...
Examples:
  ...
  python run_integration_tests.py --fast             # Run only fast tests
  python run_integration_tests.py --performance      # Run performance tests
  python run_integration_tests.py --platform windows # Run platform-specific tests
  python run_integration_tests.py --module lifecycle # Run specific test module
  python run_integration_tests.py --end-to-end       # Run end-to-end tests
  python run_integration_tests.py --verbose --debug  # Run with maximum output
        """,
    )
    ...
    parser.add_argument(
        "--performance", action="store_true", help="Run performance and load tests"
    )
    ...
    if args.parallel:
        ...
        try:
            ...
            print(
                "WARNING: pytest-xdist not found. Install with: pip install pytest-xdist"
            )
    ...
    if args.timeout:
        ...
        try:
            ...
            print(
                "WARNING: pytest-timeout not found. Install with: pip install pytest-timeout"
            )
    ...
    if args.report:
        print(f"📊 Test report generated in: test_reports/")
