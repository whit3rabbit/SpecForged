...
import pytest
from src.core.classifier import ModeClassifier
from src.models import UserMode
...
def test_confidence_sum():
    ...
    total_confidence = result.chat_confidence + result.do_confidence + result.spec_confidence
