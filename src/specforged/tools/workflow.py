    ...
    async def transition_workflow_phase(
        ...
        try:
            ...
            if spec_manager.transition_phase(spec_id, new_phase):
                ...
                if ctx:
                    await ctx.info(f"Transitioned spec {spec_id} to {target_phase} phase")
        ...
        for task_number in task_numbers:
            try:
                ...
                if success:
                    ...
                    results.append({"task_number": task_number, "status": "failed", "message": "Task not found"})
            except Exception as e:
                results.append({"task_number": task_number, "status": "error", "message": str(e)})
