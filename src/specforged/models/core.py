...
class Task:
    ...
    subtasks: List["Task"] = field(default_factory=list)  # Now Task objects instead of strings
    ...
    def update_status_from_subtasks(self) -> None:
        ...
        if self.subtasks:
            ...
            elif any(subtask.status == "in_progress" or subtask.is_completed for subtask in self.subtasks):
