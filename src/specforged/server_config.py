...
class ConfigurationLoader:
    ...
    def _detect_project_root(self) -> Path:
        ...
        markers = [
            ".git", ".hg", ".svn",  # VCS
            "package.json", "pyproject.toml", "Cargo.toml",  # Package managers
            ".specforged.yaml", ".specforged.yml",  # Our config
    ...
    def _load_user_config(self) -> Optional[Dict[str, Any]]:
        ...
        if not config_file.exists():
            ...
            for alt_name in ["config.yml", "specforged.yaml", "specforged.yml"]:
    ...
    def _load_project_config(self) -> Optional[Dict[str, Any]]:
        ...
        config_names = [".specforged.yaml", ".specforged.yml", "specforged.yaml", "specforged.yml"]
        ...
        for config_name in config_names:
            ...
            if config_file.exists():
                try:
                    ...
                    print(f"Warning: Failed to load project config from {config_file}: {e}")
                    continue
    ...
    def create_default_user_config(self) -> bool:
        ...
        clean_config = {k: v for k, v in default_config.items() if v is not None and not k.startswith("#")}
